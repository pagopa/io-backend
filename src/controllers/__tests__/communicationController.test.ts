...
describe("CommunicationController#getMessagesByUser", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("calls the getMessagesByUser on the CommunicationController with user only", async () => {
    const req = mockReq();
  ...
  it("calls the getMessagesByUser on the CommunicationController with user and partial pagination parameters", async () => {
    const req = mockReq();
  ...
  it("calls the getMessagesByUser on the CommunicationController with user and all pagination parameters", async () => {
    const req = mockReq();
  ...
  it("calls the getMessagesByUser on the CommunicationController with empty user", async () => {
    const req = mockReq();
    const res = mockRes();
...
describe("CommunicationController#getMessage", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("calls the getMessage on the CommunicationController with valid values", async () => {
    const req = mockReq();
  ...
  it("calls the getMessage on the CommunicationController with empty opional parameters", async () => {
    const req = mockReq();
  ...
  it("calls the getMessage on the CommunicationController with empty user", async () => {
    const req = mockReq();
    const res = mockRes();
...
describe("CommunicationController#getThirdPartyAttachment", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
describe("CommunicationController#upsertMessageStatus", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it.each`
    ...
    ${mockedUser} | ${{ id: anId }} | ${{}}
  `(
    "should not call the upsertMessage on the CommunicationController with wrong parameters",
