...
export const notificationDetailResponseExampleAsObject = 
{
    ...
    "timeline": [
        ...
        {
            "elementId": "KMZV-LYMY-TDMZ-202207-J-1_get_address0_source_DigitalAddressSourceInt.PLATFORM(value=PLATFORM)_attempt_0",
        ...
        {
            "elementId": "KMZV-LYMY-TDMZ-202207-J-1_get_address0_source_DigitalAddressSourceInt.SPECIAL(value=SPECIAL)_attempt_0",
        ...
        {
            "elementId": "KMZV-LYMY-TDMZ-202207-J-1_0_DeliveryModeInt.DIGITAL(value=DIGITAL)_ContactPhaseInt.CHOOSE_DELIVERY(value=CHOOSE_DELIVERY)_0_public_registry_call",
        ...
        {
            "elementId": "public_registry_response_KMZV-LYMY-TDMZ-202207-J-1_0_DeliveryModeInt.DIGITAL(value=DIGITAL)_ContactPhaseInt.CHOOSE_DELIVERY(value=CHOOSE_DELIVERY)_0_public_registry_call",
        ...
        {
            "elementId": "KMZV-LYMY-TDMZ-202207-J-1_get_address0_source_DigitalAddressSourceInt.GENERAL(value=GENERAL)_attempt_0",
