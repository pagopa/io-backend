...
exports.DigitalCitizenshipAPIModels = Models;
const Mappers = require("./models/mappers");
exports.DigitalCitizenshipAPIMappers = Mappers;
...
class DigitalCitizenshipAPI extends msRest.ServiceClient {
     ...
     *
     */
    constructor(fiscalCode, credentials, baseUri, options) {
    ...
    getService(serviceId, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getServiceWithHttpOperationResponse(serviceId, options).then((operationRes) => {
            ...
            msRest.promiseToCallback(this.getServiceWithHttpOperationResponse(serviceId, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
    ...
    getMessage(id, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        let cb = callback;
        if (!callback) {
            return this.getMessageWithHttpOperationResponse(id, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getMessageWithHttpOperationResponse(id, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    getMessagesByUser(options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        let cb = callback;
        if (!callback) {
            return this.getMessagesByUserWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getMessagesByUserWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    submitMessageforUser(options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        let cb = callback;
        if (!callback) {
            return this.submitMessageforUserWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.submitMessageforUserWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    getProfile(options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getProfileWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getProfileWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    upsertProfile(options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        let cb = callback;
        if (!callback) {
            return this.upsertProfileWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.upsertProfileWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    getInfo(options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getInfoWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getInfoWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
...
exports.DigitalCitizenshipAPI = DigitalCitizenshipAPI;
//# sourceMappingURL=digitalCitizenshipAPI.js.map